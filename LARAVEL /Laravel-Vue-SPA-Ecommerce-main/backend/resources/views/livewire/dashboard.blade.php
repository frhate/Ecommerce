                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-borderless datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th scope="row"><img height="55px" src="{{ asset('storage/products/' . $product[1]) }}" alt="{{ $product[1] }}">
                                                </th>
                                                <td>{{ $product[2] }}
                                                </td>
                                                <td>{{ $product[3] }}</td>
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <table class="table table-borderless">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th scope="row"> <img src="{{ url('storage/products/' . $topRevenueProduct->product->image) }}"
