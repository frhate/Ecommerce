...
const getImageUrl = (imageName) => {
  return `http://127.0.0.1:8000/storage/products/${imageName}`;
};
            ...
            <div class="col-lg-5 pb-5">
                ...
                >
                    <div class="carousel-inner border">
                      <template v-for="(image, index) in responseData.product.gallery.split(',')" :key="index">
                        <div :class="['carousel-item', { active: index === 0 }]">
                          <img class="w-100 h-100" :src="getImageUrl(image.trim())" alt="image" />
                        </div>
                      </template>
                    </div>
                    <a
