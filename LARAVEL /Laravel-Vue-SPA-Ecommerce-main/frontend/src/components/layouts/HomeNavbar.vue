                ...
                <div class="row border-top px-xl-5">
                                ...
                                <template v-for="(data, key) in responseData.allCategory" :key="key">
                                    <template v-if="data.category.length !== 0">
                                            <div class="nav-item dropdown">
                                                ...
                                                ></a>
                                                <div class="dropdown-menu position-absolute bg-white border-0 rounded-0 w-100 m-0">
                    ...
                    <div class="col-lg-9">
                        ...
                        >
                            ...
                            <div class="carousel-item active" style="height: max-content;">
                            <img class="img-fluid" src="../images/banner.jpg" alt="Image">
